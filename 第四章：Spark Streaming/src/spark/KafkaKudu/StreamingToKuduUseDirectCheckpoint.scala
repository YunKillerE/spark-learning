...
/**
  ...
  */
object StreamingToKuduUseDirectCheckpoint extends Serializable {
...
/*
    ...
    val topicq = Array(topic)

    val stream = KafkaUtils.createDirectStream[String, String, StringDecoder, StringDecoder](ssc, kafkaParamsq, "json".split(",").toSet )
*/
